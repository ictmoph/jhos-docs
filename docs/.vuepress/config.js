    ...
    sidebar: [
      {
        ...
        children: [
          ...
          '/user-manual/03-หน้าจอบันทึกการจ่ายยาผู้ป่วยใน',
          '/user-manual/04-หน้าจอบันทึกรายการLabผู้ป่วยใน',
          '/user-manual/05-หน้าจอบันทึกรายการX-Rayผู้ป่วยใน',
          '/user-manual/06-หน้าจอหัตถการผู้ป่วยใน',
          '/user-manual/07-หน้าจอบันทึกรายการอื่น ๆ ผู้ป่วยใน',
          '/user-manual/08-หน้าจอสรุปค่าใช้จ่ายผู้ป่วยใน',
