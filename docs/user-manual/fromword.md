...
4. ระบุรายละเอียดรายการยาของผู้ป่วย โดยสามารถเลือกพิมพ์ใบสั่งยาได้โดยมีสองปุ่มให้เลือก
  - ปุ่ม  คือเลือกพิมพ์เฉพาะตัวยาที่ต้องการจะพิมพ์  
...
จอแสดงข้อมูลผู้ป่วยที่มีชื่อเดียวกันแต่ HN ไม่เหมือนกัน
1.นำไฟล์ javadaemon ลงคอมพิวเตอร์
2. เปิด Notepad แล้วพิมพ์คำสั่งดังนี้
cd c:\  ที่อยู่ของไฟล์ javadaemon ที่วางในคอมพิวเตอร์ \javadaemon
...
__**ไม่ควรกำหนด sectioncode และ subsectioncode ให้กับรายการหัตถการเหล่านี้ ยกเว้น sectioncode รหัส 99 ซึ่งกำหนดเป็นหัตถการสำหรับหัตถการทั่วไป (ห้องฉีดยา, ทำแผล) กำหนดรายการหัตถการตามแผนกโดยระบุที่ sectioncode และ subsectioncode เรื่มอ่านที่รหัส ##01 (## คือ รหัส sectioncode) โดยยกเว้นรหัส subsectioncode ที่ลงท้ายด้วย 00 เอาไว้__

ตัวอย่างรายการหัตถการที่ใช้เฉพาะแผนก
- SELECT operatcode, operatdesc, sectioncode, subsectioncode
FROM  c_operation
WHERE sectioncod = 14
__**เมนูหัตถการแผนไทย__

ตัวอย่าง 2 รายการหัตถการที่มีบางรายการที่ใช้ร่วมกัน
SELECT operatcode, operatdesc, sectioncode, subsectioncode
FROM  c_operation
WHERE sectioncod = '22' or operattypecode = '00'
__**เมนูหัตถการเครื่องมือพิเศษ__
